...
ты можешь из этого сделать нормальный ридми файл ну или сайт куда я могу это вставить и оно отредактируется
...
```
[Burov Ivan]. (2025). High-Accuracy CCS Prediction using Graph Neural Networks. GitHub. https://github.com/your-username/Metlin_CCS
```
